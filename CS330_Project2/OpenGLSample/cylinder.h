	...
	*/
	...
	public:
		Cylinder(float radius, int numSlices, float height,
			bool withPositions = true, bool withTextureCoordinates = true, bool withNormals = true, bool withRotation = false, bool cup = false);
	...
	private:
		...
		bool _rotation; // boolean to declare the direction of the cylinder ie vertical or horizontal
